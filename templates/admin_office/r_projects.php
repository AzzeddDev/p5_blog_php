...
$title = "Poster un projet";

require('../../src/model/model.php');
require('../../src/controllers/admin/admin.php');
require('../../src/controllers/admin/r_projects_admin.php');
                ...
                <div class="row g-3">
                    ...
                    <div class="col-8">
                        <div class="bg-dashboard-blocs mb-3">
                            ...
                            <h1 class="hello-txt">Rédactions projets</h1>
                        </div>
                            ...
                            <div class="btn-aside-db d-flex justify-content-between p-4">
                                <div class="col-12">
                                    <div class="bloc-icon-main mb-3">
                                        <i class="fa-regular fa-images pe-2"></i>
                                        <h2 class="tu-db m-0">Poster votre projet</h2>
                                    </div>

                                    <form class="row g-3 pb-3" action="../../src/controllers/admin/r_projects_admin.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <input class="default-form-db" type="text" name="date_project" placeholder="Date de création du projet" />
