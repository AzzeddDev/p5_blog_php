...
if(isset($_SESSION['role_user'])){
    ...
    if($_SESSION['role_user']==1) {
        ...
        <!-- Navbar -->
        <?php require('templates/admin_office/header.php'); ?>
                ...
                <div class="container header-mb mt-4">
                    <div class="bg-header">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <img class="img-fluid" src="http://localhost/mon-blog/web/me_index.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Footer -->
        <?php require('templates/back_office/footer.php'); ?>

        <?php $content = ob_get_clean(); ?>

        <?php require('templates/back_office/layout.php') ?>

        <?php
    }

    elseif ($_SESSION['role_user']==0) {
        ?>

        <!-- Navbar -->
        <?php require('templates/back_office/header.php'); ?>
