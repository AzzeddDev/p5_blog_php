            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="http://localhost/mon-blog/templates/back_office/dashboard-user.php">Dashboard</a></li>
                        <li><a class="dropdown-item" href="http://localhost/mon-blog/templates/back_office/dashboard-settings.php">Paramètre</a></li>
